...
//
//        mTrackView = new TrackView (getContext (), mTrackViewX/*this.getWidth () / 2*/, mTrackViewY/*this.getHeight () / 2*/);
//        mTrackView.setAlpha (0f);
//        mTrackView.setInteractionListener ((x, y, down) -> {
//            dispatchOnPositionChanged (null, x, y, 0, 0, 0, 0, down);
//
